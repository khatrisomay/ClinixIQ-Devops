...
CANONICAL_SYMPTOMS = {
    "fever": ["fever", "high temp", "temperature", "chills", "febrile", "hot", "sweating", "shivering"],
    "chest_pain": ["chest pain", "chest tightness", "chest pressure", "heart pain", "crushing chest", "sternum pain", "angina"],
    "shortness_of_breath": ["short of breath", "shortness of breath", "breathless", "breathing difficulty", "dyspnea", "wheezing", "gasping", "hard to breathe"],
    "cough": ["cough", "dry cough", "productive cough", "hacking", "phlegm", "mucus", "coughing"],
    "headache": ["headache", "migraine", "head throbbing", "pain in head", "temple pain", "cranial pressure"],
    "fatigue": ["fatigue", "tired", "exhausted", "lethargic", "weakness", "low energy", "worn out"],
    "sore_throat": ["sore throat", "throat pain", "throat irritation", "difficulty swallowing", "scratchy throat"],
    "nausea_vomiting": ["nausea", "nauseous", "vomiting", "threw up", "throwing up", "queasy"],
    "abdominal_pain": ["abdominal pain", "stomach pain", "belly ache", "cramps", "gut pain", "stomach cramps"],
    "dizziness": ["dizzy", "dizziness", "lightheaded", "vertigo", "spinning sensation", "unsteady"],
    "body_aches": ["body aches", "muscle pain", "joint pain", "myalgia", "arthralgia", "sore muscles"],
    ...
    "palpitations": ["palpitations", "racing heart", "rapid heartbeat", "fluttering heart", "tachycardia"],
