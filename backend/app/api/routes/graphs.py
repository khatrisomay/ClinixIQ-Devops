...
from app.services.graph_generator import generate_differential_bar_svg, generate_risk_curve_svg
...
async def get_risk_curve(
    condition: str = Query("Viral Upper Respiratory Infection", description="Predicted condition"),
    peak_day: int = Query(4, ge=1, le=12),
):
    """
